...
using Uint8_c = NonParametricType_t<NPTerm::UINT8,int8_t>; // Maybe make Uint8Term
using Uint16_c = NonParametricType_t<NPTerm::UINT16,int16_t>; // Maybe make Uint16Term
using Uint32_c = NonParametricType_t<NPTerm::UINT32,int32_t>; // Maybe make Uint32Term
using Uint64_c = NonParametricType_t<NPTerm::UINT64,int64_t>; // Maybe make Uint64Term
