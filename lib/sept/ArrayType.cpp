...
SEPT_ABSTRACT_TYPE_OF_DATA_REGISTER_TYPE_DEFAULT(ArrayES_c)
SEPT_ABSTRACT_TYPE_OF_DATA_REGISTER_TYPE_DEFAULT(ArrayE_c)
SEPT_ABSTRACT_TYPE_OF_DATA_REGISTER_TYPE_DEFAULT(ArrayS_c)
SEPT_ABSTRACT_TYPE_OF_DATA_REGISTER_TYPE_DEFAULT(Array_c)

SEPT_ABSTRACT_TYPE_OF_DATA_REGISTER_TYPE_DEFAULT(ArrayType_c)

SEPT_ABSTRACT_TYPE_OF_DATA_REGISTER_TYPE_DEFAULT(ArrayESTerm_c)
SEPT_ABSTRACT_TYPE_OF_DATA_REGISTER_TYPE_DEFAULT(ArrayETerm_c)
SEPT_ABSTRACT_TYPE_OF_DATA_REGISTER_TYPE_DEFAULT(ArraySTerm_c)

SEPT_ABSTRACT_TYPE_OF_DATA_REGISTER_TYPE_DEFAULT(ArrayTerm_c)
...
SEPT_SERIALIZE_DATA_REGISTER_TYPE_DEFAULT(ArrayType_c)
SEPT_SERIALIZE_DATA_REGISTER_TYPE_DEFAULT(ArrayES_c)
SEPT_SERIALIZE_DATA_REGISTER_TYPE_DEFAULT(ArrayE_c)
SEPT_SERIALIZE_DATA_REGISTER_TYPE_DEFAULT(ArrayS_c)
SEPT_SERIALIZE_DATA_REGISTER_TYPE_DEFAULT(Array_c)
SEPT_SERIALIZE_DATA_REGISTER_TYPE_DEFAULT(ArrayESTerm_c)
