...
SEPT__REGISTER__HASH(OrderedMapDCTerm_c)
SEPT__REGISTER__HASH(OrderedMapDTerm_c)
SEPT__REGISTER__HASH(OrderedMapCTerm_c)
SEPT__REGISTER__HASH(OrderedMapDC_c)
SEPT__REGISTER__HASH(OrderedMapD_c)
SEPT__REGISTER__HASH(OrderedMapC_c)
SEPT__REGISTER__HASH(OrderedMap_c)
SEPT__REGISTER__HASH(OrderedMapType_c)
