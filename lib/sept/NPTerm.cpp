...
SEPT__REGISTER__HASH(NonParametricTerm_c)
SEPT__REGISTER__HASH(Void_c)
SEPT__REGISTER__HASH(BoolTerm_c)
SEPT__REGISTER__HASH(True_c)
SEPT__REGISTER__HASH(False_c)
