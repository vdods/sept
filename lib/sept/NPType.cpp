...
SEPT__REGISTER__HASH(Term_c)
SEPT__REGISTER__HASH(Type_c)
SEPT__REGISTER__HASH(NonType_c)
SEPT__REGISTER__HASH(NonParametricType_c)
SEPT__REGISTER__HASH(EmptyType_c)
SEPT__REGISTER__HASH(VoidType_c)
SEPT__REGISTER__HASH(TrueType_c)
SEPT__REGISTER__HASH(FalseType_c)
SEPT__REGISTER__HASH(Bool_c)
SEPT__REGISTER__HASH(Sint8_c)
SEPT__REGISTER__HASH(Sint16_c)
SEPT__REGISTER__HASH(Sint32_c)
SEPT__REGISTER__HASH(Sint64_c)
SEPT__REGISTER__HASH(Uint8_c)
SEPT__REGISTER__HASH(Uint16_c)
SEPT__REGISTER__HASH(Uint32_c)
SEPT__REGISTER__HASH(Uint64_c)
SEPT__REGISTER__HASH(Float32_c)
SEPT__REGISTER__HASH(Float64_c)
SEPT__REGISTER__HASH(BoolType_c)
SEPT__REGISTER__HASH(Sint8Type_c)
SEPT__REGISTER__HASH(Sint16Type_c)
SEPT__REGISTER__HASH(Sint32Type_c)
SEPT__REGISTER__HASH(Sint64Type_c)
SEPT__REGISTER__HASH(Uint8Type_c)
SEPT__REGISTER__HASH(Uint16Type_c)
SEPT__REGISTER__HASH(Uint32Type_c)
SEPT__REGISTER__HASH(Uint64Type_c)
SEPT__REGISTER__HASH(Float32Type_c)
SEPT__REGISTER__HASH(Float64Type_c)
...
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Void_c, VoidType_c)
...
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Void_c, NonParametricTerm_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Void_c, NonType_c)

SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(VoidType_c, NonParametricTerm_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(VoidType_c, Type_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(VoidType_c, NonParametricType_c)

SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(True_c, TrueType_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(False_c, FalseType_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(True_c, Bool_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(False_c, Bool_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(BoolTerm_c, Bool_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(bool, Bool_c) // bool and BoolTerm_c are equivalent
SEPT__REGISTER__INHABITS__NONDATA(BoolTerm_c, TrueType_c)
SEPT__REGISTER__INHABITS__NONDATA(BoolTerm_c, FalseType_c)
SEPT__REGISTER__INHABITS__NONDATA(bool, TrueType_c)
SEPT__REGISTER__INHABITS__NONDATA(bool, FalseType_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Bool_c, BoolType_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(TrueType_c, BoolType_c) // TrueType is a subtype of Bool
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(FalseType_c, BoolType_c) // FalseType is a subtype of Bool

SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(int8_t, Sint8_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(int16_t, Sint16_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(int32_t, Sint32_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(int64_t, Sint64_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Sint8_c, Sint8Type_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Sint16_c, Sint16Type_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Sint32_c, Sint32Type_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Sint64_c, Sint64Type_c)

SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(uint8_t, Uint8_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(uint16_t, Uint16_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(uint32_t, Uint32_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(uint64_t, Uint64_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Uint8_c, Uint8Type_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Uint16_c, Uint16Type_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Uint32_c, Uint32Type_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Uint64_c, Uint64Type_c)

SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(float, Float32_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(double, Float64_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Float32_c, Float32Type_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Float64_c, Float64Type_c)

SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Term_c, Type_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(NonParametricTerm_c, Type_c)
// SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(ParametricTerm_c, Type_c)

SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(Type_c, Type_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(NonType_c, Type_c)
SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(NonParametricType_c, Type_c)
// SEPT__REGISTER__INHABITS__NONDATA__UNCONDITIONAL(ParametricType_c, Type_c)
...
SEPT__REGISTER__CONSTRUCT_INHABITANT_OF(Bool_c, bool)
SEPT__REGISTER__CONSTRUCT_INHABITANT_OF(Bool_c, BoolTerm_c)
SEPT__REGISTER__CONSTRUCT_INHABITANT_OF(Sint8_c, int8_t)
SEPT__REGISTER__CONSTRUCT_INHABITANT_OF(Sint16_c, int16_t)
SEPT__REGISTER__CONSTRUCT_INHABITANT_OF(Sint32_c, int32_t)
SEPT__REGISTER__CONSTRUCT_INHABITANT_OF(Sint64_c, int64_t)
SEPT__REGISTER__CONSTRUCT_INHABITANT_OF(Uint8_c, uint8_t)
SEPT__REGISTER__CONSTRUCT_INHABITANT_OF(Uint16_c, uint16_t)
SEPT__REGISTER__CONSTRUCT_INHABITANT_OF(Uint32_c, uint32_t)
SEPT__REGISTER__CONSTRUCT_INHABITANT_OF(Uint64_c, uint64_t)
SEPT__REGISTER__CONSTRUCT_INHABITANT_OF(Float32_c, float)
SEPT__REGISTER__CONSTRUCT_INHABITANT_OF(Float64_c, double)
